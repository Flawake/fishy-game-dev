...
public class FishSpots : NetworkBehaviour
{
    ...
    // The water collider, exposed so the radar renderer can build a stencil
    // mask that clips fish spot sprites to the water's exact shape.
    internal Collider2D WaterCollider => waterCollider;
